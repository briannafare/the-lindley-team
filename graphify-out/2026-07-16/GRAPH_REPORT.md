# Graph Report - the-lindley-team  (2026-07-16)

## Corpus Check
- 181 files · ~555,242 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1150 nodes · 1679 edges · 100 communities (80 shown, 20 thin omitted)
...
- `PaymentDonut()` --calls--> `formatCurrency()`  [EXTRACTED]
  mortgage-calculator-suite 2/app/conventional/page.tsx → mortgage-calculator-suite 2/lib/format.ts
- `ProFormaRow()` --calls--> `formatCurrency()`  [EXTRACTED]
  mortgage-calculator-suite 2/app/investment/page.tsx → mortgage-calculator-suite 2/lib/format.ts
- `ComparisonCard()` --calls--> `formatCurrency()`  [EXTRACTED]
  mortgage-calculator-suite 2/app/refinance/page.tsx → mortgage-calculator-suite 2/lib/format.ts
...
Cohesion: 0.11
Nodes (22): BreakdownRow(), ConventionalPage(), CREDIT_SCORE_OPTIONS, DonutLegendRow(), LOAN_TERMS, Occupancy, parseCurrencyInput(), PaymentDonut() (+14 more)
...
Cohesion: 0.14
Nodes (12): BuyNowVsWaitPage(), ScenarioCard(), TERM_OPTIONS, CashToClosePage(), CltvPage(), PaymentDonut(), TaxDeductionPage(), BuyNowVsWaitInputs (+4 more)
...
Cohesion: 0.13
Nodes (9): BreakdownRow(), DonutLegendRow(), HOUSEHOLD_SIZES, LOAN_TERMS, PaymentDonut(), Props, AmortizationRow, UsdaInputs (+1 more)
...
Cohesion: 0.16
Nodes (10): DEFAULT_PREPAIDS, PROGRAM_LABELS, PROGRAM_MIN_DOWN, ScenarioCard(), WaterfallRow(), calculateCashToClose(), CashToCloseInputs, CashToCloseOutputs (+2 more)
...
Cohesion: 0.26
Nodes (9): calculateMonthlyPi(), calculateTotalInterest(), DscrOutputs, calculateUsdaFees(), UsdaFeeContext, UsdaFeeResult, InvestmentPropertyOutputs, calculateUsdaPayment() (+1 more)
...
Cohesion: 0.22
Nodes (5): InvestmentPropertyPage(), ProFormaRow(), TERM_OPTIONS, calculateInvestmentProperty(), InvestmentPropertyInputs

### Community 41 - "page.tsx"
Cohesion: 0.25
Nodes (4): DscrPage(), TERM_OPTIONS, calculateDscr(), DscrInputs
...
## Knowledge Gaps
- **493 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `SCENARIO_META`, `TERM_OPTIONS`, `PROGRAM_MIN_DOWN` (+488 more)
...
- **Why does `formatCurrency()` connect `Refinance Loans` to `page.tsx`, `Core Conversion Pages`, `page.tsx`, `Calculator and Loans`, `page.tsx`, `page.tsx`, `Motion Utilities`, `Service Marquee`, `Primary CTA`, `Featured Neighborhoods`?**
