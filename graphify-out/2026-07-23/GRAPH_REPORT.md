...
Cohesion: 0.04
Nodes (44): eslint, eslint-config-next, gsap, @gsap/react, livekit-client, marked, dependencies, gsap (+36 more)
...
Cohesion: 0.11
Nodes (24): CltvPage(), BreakdownRow(), ConventionalPage(), CREDIT_SCORE_OPTIONS, DonutLegendRow(), LOAN_TERMS, Occupancy, parseCurrencyInput() (+16 more)
...
Cohesion: 0.18
Nodes (7): ComparisonCard(), NEW_TERM_OPTIONS, RefinancePage(), calculateRefinance(), ClosingCostStrategy, RefinanceInputs, RefinanceOutputs
...
Cohesion: 0.20
Nodes (6): InvestmentPropertyPage(), ProFormaRow(), TERM_OPTIONS, calculateInvestmentProperty(), InvestmentPropertyInputs, InvestmentPropertyOutputs

### Community 41 - "page.tsx"
Cohesion: 0.22
Nodes (5): DscrPage(), TERM_OPTIONS, calculateDscr(), DscrInputs, DscrOutputs
...
## Knowledge Gaps
- **505 isolated node(s):** `next/core-web-vitals`, `next/typescript`, `SCENARIO_META`, `TERM_OPTIONS`, `PROGRAM_MIN_DOWN` (+500 more)
