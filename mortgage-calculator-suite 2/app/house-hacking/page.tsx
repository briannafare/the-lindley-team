  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 py-10 space-y-8">
        {/* Header */}
        <div>
          <h1 className="text-3xl font-bold text-gray-900">House Hacking & Multi-Unit Affordability</h1>
          <p className="text-gray-500 mt-1">
            Buy a 2–4 unit property, live in one unit, and let tenants pay your mortgage.
          </p>
        </div>
