...
export const metadata: Metadata = {
  title: "Apply with David or Bri · The Lindley Team",
  description:
    "Start your mortgage application with David Chandler or Bri Lindley at Movement Mortgage.",
};

// The picker. /apply itself goes straight to an application, so nobody hits this by accident;
// you only land here from /about or a team card, where you have met both of them.
export default function ApplyChoosePage() {
  return (
    <>
      <Nav />
          ...
          <div className="grid md:grid-cols-2 gap-6 lg:gap-8 mt-[clamp(64px,8vw,112px)]">
            ...
            <div className="group overflow-hidden rounded-[1.5rem] border border-border bg-paper shadow-[0_24px_70px_rgba(0,0,0,0.05)]">
              ...
              <div className="p-6 sm:p-8 flex flex-col">
                ...
                <p className="text-[0.95rem] text-ink-mid leading-relaxed mt-5 flex-1">
                  Licensed in OR, WA &amp; AZ. Jumbo, new construction, self-employed and investment property.
                </p>
                <div className="mt-7">
                  <Btn href={APPLY_DAVID} external variant="primary" size="lg" className="w-full justify-between sm:w-auto">
                    Apply with David
                  </Btn>
                </div>
              </div>
            ...
            <div className="group overflow-hidden rounded-[1.5rem] border border-border bg-paper shadow-[0_24px_70px_rgba(0,0,0,0.05)]">
              ...
              <div className="p-6 sm:p-8 flex flex-col">
                ...
                <div className="mt-7">
                  <Btn href={APPLY_BRI} external variant="outline" size="lg" className="w-full justify-between sm:w-auto">
                    Apply with Bri
                  </Btn>
                </div>
              </div>
