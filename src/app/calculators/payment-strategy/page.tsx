...
import PaymentStrategyCalculator from "@/components/calculators/PaymentStrategyCalculator";
import { getToolBySlug } from "@/lib/calculator-tools";

const tool = getToolBySlug("payment-strategy")!;

export const metadata: Metadata = {
  title: tool.metaTitle,
  description: tool.metaDescription,
  alternates: { canonical: "/calculators/payment-strategy" },
};
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      name: tool.name,
      url: `https://thelindleyteam.com/calculators/payment-strategy`,
