...
import CashToCloseCalculator from "@/components/calculators/CashToCloseCalculator";
import { getToolBySlug } from "@/lib/calculator-tools";

const tool = getToolBySlug("cash-to-close")!;

export const metadata: Metadata = {
  title: tool.metaTitle,
  description: tool.metaDescription,
  alternates: { canonical: "/calculators/cash-to-close" },
};
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      name: tool.name,
      url: `https://thelindleyteam.com/calculators/cash-to-close`,
