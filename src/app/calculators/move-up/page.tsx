...
import MoveUpCalculator from "@/components/calculators/MoveUpCalculator";
import { getToolBySlug } from "@/lib/calculator-tools";

const tool = getToolBySlug("move-up")!;

export const metadata: Metadata = {
  title: tool.metaTitle,
  description: tool.metaDescription,
  alternates: { canonical: "/calculators/move-up" },
};
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      name: tool.name,
      url: `https://thelindleyteam.com/calculators/move-up`,
