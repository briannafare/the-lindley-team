...
import CltvCalculator from "@/components/calculators/CltvCalculator";
import { getToolBySlug } from "@/lib/calculator-tools";

const tool = getToolBySlug("cltv")!;

export const metadata: Metadata = {
  title: tool.metaTitle,
  description: tool.metaDescription,
  alternates: { canonical: "/calculators/cltv" },
};
  ...
  "@graph": [
    {
      "@type": "WebApplication",
      name: tool.name,
      url: `https://thelindleyteam.com/calculators/cltv`,
