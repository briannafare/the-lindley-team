        ...
        <section className="pt-40 pb-20 relative overflow-hidden">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <h1 className="font-serif text-[clamp(3rem,8vw,6rem)] font-semibold leading-[0.92] tracking-[-0.03em] mb-6">
              The<br />
              <em className="italic font-medium text-orange">Journal</em>
            </h1>
        ...
        <section className="py-20 bg-yellow">
          <div className="max-w-[1400px] mx-auto px-6 lg:px-10">
            <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr] gap-8">
              ...
              <div className="max-w-[620px] rounded-[1.5rem] border border-ink/10 bg-paper p-6 shadow-[0_24px_70px_rgba(0,0,0,0.06)] sm:p-8">
                ...
                <label htmlFor="journal-email" className="mb-2 block text-[0.68rem] font-bold tracking-[0.12em] uppercase text-ink-mid">
                  Email
                </label>
                <div className="flex flex-col sm:flex-row gap-3">
                  <input
                    ...
                    disabled
                    className="flex-1 px-5 py-3.5 rounded-xl border border-transparent bg-bg-alt text-[0.88rem] text-ink placeholder:text-ink-light focus:outline-none focus:border-ink disabled:opacity-60 disabled:cursor-not-allowed"
                  />
                  <button
                    disabled
