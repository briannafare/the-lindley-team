...
export default function ColorBlockCTA() {
  return (
    <section className="max-w-[1440px] mx-auto px-5 lg:px-[54px] mt-[clamp(64px,9vw,130px)]">
      <div className="bg-ink text-paper rounded-[3px] px-[clamp(28px,5vw,80px)] py-[clamp(40px,6vw,96px)] grid md:grid-cols-[1.3fr_1fr] gap-8 md:gap-10 md:items-end">
        <h2 className="font-serif font-semibold text-[clamp(38px,6vw,92px)] leading-[0.92] tracking-[-0.03em]">
          Start with the <em className="italic text-orange">block</em>, not the rate.
        </h2>
