...
FAQS = {
    ...
    # Added 2026-09-17 when the prompt was cut from 15.6k to 5.8k characters: facts that lived in the
    # prompt now live here, where the agent retrieves them only when a caller asks.
    "What is on the website":
        "thelindleyteam.com has a page for each loan type under services: purchase, refinance, "
        "divorce lending, FHA, VA, USDA, jumbo, conventional, HELOC, cash-out, investment, reverse "
        "mortgage, new construction, bank statement, DSCR, and down payment assistance. There is a "
        "first-time buyer guide, about ninety Portland-area neighborhood pages, seventeen mortgage "
        "calculators, a contact page, and the application at thelindleyteam.com/apply.",

    "How do I reach David or Bri directly":
        "Call or text 971-754-1771 and the team picks it up. Email works too: David is "
        "david.chandler@movement.com and Bri is brianna.lindley@movement.com. Most of the work "
        "happens by phone, text, and email, so there is no need to come into the office.",

    "What happens in a consultation":
        "About thirty minutes on the phone or video with David or Bri. They ask what you are trying "
        "to do, look at where you stand, and tell you plainly what the options are and what they "
        "would do next. It is complimentary and there is no obligation. You get a text confirmation "
        "when you book, and the meeting is always with David or Bri, never with an assistant.",

    "What happens after I apply":
        "The application runs securely through Movement and takes about fifteen minutes. You can "
        "save it and come back. David and Bri both see it come in and sort out who picks it up, "
        "then one of them follows up with you. If you hit a snag partway through, such as a "
        "document that will not upload or a question that is unclear, text 971-754-1771 and a "
        "person will unstick it.",

    "What does Movement Mortgage do for the community":
        "Movement Mortgage is an Impact Lender: ten percent or more of its profits go back into "
        "communities through the Movement Foundation. David and Bri are loan officers there, so "
        "most loan programs live in-house instead of being sent out to other lenders.",
}
